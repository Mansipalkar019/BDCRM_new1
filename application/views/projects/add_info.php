<html lang="en">
   ...
   <body class="" >
      ...
      <main class="container-fluid" style="background-color: #FFFFEA;">
         ...
         <div class="alert alert-warning text-center p-1" role="alert" id="">
                  <?php 
                     ...
                     $id = $allInfo[0]['id'];
                     $company_name = $allInfo[0]['company_name'];
                  ...
                  <?php
                   ...
                   <a type='submit' title="Folow up" data-bs-toggle="modal" data-bs-target="#call_back" class='btn btn-purple btn-sm waves-effect waves-light' style="float:left;background-color: darkred;margin-top:-1px;margin-right:3%;color:white;">Followup&nbsp;<i class="fa fa-phone" aria-hidden="true"></i></a>
             ...
             <div class="modal fade" id="call_back" tabindex="-1" aria-labelledby="briefDetailsLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                     <div class="modal-content">
                        <div class="modal-header">
                           <h5 class="modal-title" id="briefDetailsLabel">Call Back</h5>
                        </div>
                              ...
                              <div class="col-md-12 px-3" style="margin-bottom: 5px;text-align:center;">
                                 ...
                                 <div class="row align-items-center justify-content-md-center" <?= $access8; ?>>
                                       <div class="col-auto">
                                          ...
                                          <input type="date" name="from_date1" id="followup_from_date1"  class="form-control mr-2 datepicker" style="width:150px;" placeholder="DD/MM/YYYY">
                                       </div>
                                       <div class="col-auto">
                                          <label for="alternate_number" class="col-form-label"  style="font-size:15px !important;">To date:</label>
                                          <input type="date" class="form-control mr-2 datepicker" name="to_date1" id="followup_to_date1" style="width:150px;" placeholder="DD/MM/YYYY">
                                       </div>
                                       <!-- <div class="col-auto">
                                          ...
                                          <table id="example" class="table table-striped table-bordered data-table"  cellspacing="0" width="100%">
                                             <thead>
                                               ...
                                               <!-- <th  style="font-size:15px !important;">ID</th> -->
                                                   ...
                                                   <th  style="font-size:15px !important;">ID</th> 
                                                   <th  style="font-size:15px !important;">DateTime</th>
                                                   <th  style="font-size:15px !important;">Staff Name</th> 
                                                   <th  style="font-size:15px !important;">Company Name</th>
                                                   <th  style="font-size:15px !important;">Remark</th>
         ...
         <div class="row row1">
            <div class="col">
             ...
             <!--   <div class="row g-3 align-items-center justify-content-md-center" style="display: none;">
                  ...
                  <div class="col">
                     <input type="text" value="<?=  (!empty($allInfo[0]['company_name'])) ?  $allInfo[0]['company_name'] : $allInfo[0]['received_company_name']  ?>" title="" id="company_received"  name='company_received' class="form-control form-control-sm" readonly>
                  </div>
               </div> -->
               ...
               <div class="row g-3 align-items-center justify-content-md-center">
                  <div class="col">
                     <input type="hidden" value="<?=  (!empty($allInfo[0]['company_name'])) ?  $allInfo[0]['company_name'] : $allInfo[0]['company_name']  ?>" title="" id="company_received"  name='company_received' class="form-control form-control-sm" tabindex="1">
                  </div>
                  </div>
               <div class="row g-3 align-items-center justify-content-md-center">
                  <div class="col-auto">
                  ...
                  <div class="col">
                     ...
                     <input type="text" value="<?=  (!empty($allInfo[0]['company_name'])) ?  $allInfo[0]['company_name'] : $allInfo[0]['company_name']  ?>" title="" id="company_name"  name='company_name' class="form-control form-control-sm" tabindex="1">
                     <?php }else{?>
                     <input type="text" value="<?=  (!empty($allInfo[0]['company_name'])) ?  $allInfo[0]['company_name'] : $allInfo[0]['company_name']  ?>" title="" id="company_name"  name='company_name' class="form-control form-control-sm" tabindex="1">
                     <?php }
                        ?>
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access1; ?> style="margin-top:5px !important;">
                  ...
                  <?php if(in_array('address1',$project_info)){ ?>
                     <div class="col">
                  <label for="company_voice_disposition" class="col-form-label">Select Status:</label>
                     <select class='form-control form-control-sm' id="address_1"  name='address_1' tabindex="18" onchange="getdisp(this.value)">
                     <option value="">Select Status</option>
                     <option value="WIP" <?php if($allInfo[0]['address1'] == "WIP"){?> selected <?php } ?>>WIP</option>
                     <option value="Exhausted" <?php if($allInfo[0]['address1'] == "Exhausted"){?> selected <?php } ?>>Exhausted</option>
                     <option value="Fresh Records" <?php if($allInfo[0]['address1'] == "Fresh Records"){?> selected <?php } ?>>Fresh Records</option>
                     </select>
                  </div>
               ...
               <?php 
                  $div_count=div_access($project_info,array('state_county','time_zone'));
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access; ?>>
                 ...
                 <!-- check input access for state/country -->
                  ...
                  <?php } ?>
                  <?php if(in_array('time_zone',$project_info)){ ?>
                  <div class="col">
                     <label for="state_name" class="col-form-label">Time Zone:</label>
                     <input type="text" value="<?=  (!empty($allInfo[0]['time_zone'])) ?  $allInfo[0]['time_zone'] : ''  ?>" title="" id="time_zone"  name='time_zone' class="form-control form-control-sm" tabindex="6">
                  </div>
                  <?php } ?>
             ...
             <?php 
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access11; ?>>
                  ...
                  <div class="col">
                     ...
                     <input type="" value="<?=  (!empty($allInfo[0]['tel_number'])) ?  $allInfo[0]['tel_number'] : ''  ?>" title="tel_number" id="tel_number"  name='tel_number' class="form-control form-control-sm"  tabindex="12" >
             ...
             <?php 
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access2; ?>>
                 ...
                 <?php 
                  if($this->session->userdata('designation_id') == 3 || $this->session->userdata('designation_id') == 14 || $this->session->userdata('designation_id') == 1){
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access5; ?>>
                  ...
                  <div class="col">
                  <label for="company_voice_disposition" class="col-form-label">Disposition:</label>
                     <select class='form-control form-control-sm' id="company_voice_disposition"  name='company_voice_disposition' tabindex="26" onchange="getdisp(this.value)">
                        ...
                        <?php }else{ ?>
                        <option value='' disabled hidden>Select Disposition</option>
                        <?php } ?>
                        <?php 
            ...
            <div class="col">
              ...
              <?php 
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access20; ?> >
                  ...
                  <div class="col-3">
                     <label for="provided_direct_tel" class="col-form-label">Direct Tel:</label>
                     <input type="text" value="<?=  (!empty($allInfo[0]['provided_direct_tel'])) ?  $allInfo[0]['provided_direct_tel'] : ''  ?>" title="" tabindex="42" id="staff_direct_tel"  name='staff_direct_tel' class="form-control form-control-sm">
                  ...
                  <div class="col">
                     ...
                     <input type="" value="<?=  (!empty($allInfo[0]['staff_direct_tel'])) ?  $allInfo[0]['staff_direct_tel'] : ''  ?>" title="" id="staff_direct_tel"  name='staff_mobile' class="form-control form-control-sm" tabindex="43">
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access22; ?> style="margin-top:2px;">
                  ...
                  <div class="col-auto">
                     <label for="voice_staff_disposition" class="col-form-label">Sub Disposition:</label>
                  ...
                  <div class="col voice_staff_disposition">
                     ...
                     <select class='form-control form-control-sm select2 voice_staff_disposition' id="voice_staff_disposition"  name='voice_staff_disposition' tabindex="45" <?= $style; ?> style="display:block !important;">
                        ...
                        <option value='' selected disabled>select Sub Disposition</option>
                        <?php }else{ ?>
                        <option value='' disabled hidden>select Sub Disposition</option>
                        <?php }?>
                        <?php 
               ...
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access24; ?> style="margin-top:2px;">
                  ...
                  <div class="col mb-1">
                     <textarea title="" tabindex="47" id="staff_note"  name='staff_note' class="form-control form-control-sm"></textarea>
                  </div>
                  <?php } ?>
               </div>
               <div class="row g-3 align-items-center justify-content-md-center"  <?= $access13; ?> style="margin-top:10px;display:flex" id="followdatetime">
                  ...
                  <div class="input-group date" id="datetimepicker1" data-target-input="nearest">
                            <input type="text" class="form-control form-control-sm datetimepicker-input datetimepicker1" data-target="#datetimepicker1" id="from_date1" name="from_date1" placeholder="From Date" value="" tabindex="48"/>
            ...
            <div class="col">
                 <!-- check input access for ca1,ca2,ca3,ca4,ca5 -->
                 <?php 
                  $div_count=div_access($project_info,array('sa1','sa2'));
                  $access2 = ($div_count < 1) ? "style='display:none;'" :  '' ;
                  if(!empty($allInfo[0]['sa1'])){ $disableinput1='readonly'; }else{ $disableinput1='';}
                  if(!empty($allInfo[0]['sa2'])){ $disableinput2='readonly'; }else{ $disableinput2='';}
                  if(!empty($allInfo[0]['sa3'])){ $disableinput3='readonly'; }else{ $disableinput3='';} 
                  if(!empty($allInfo[0]['sa4'])){ $disableinput4='readonly'; }else{ $disableinput4='';} 
                  if(!empty($allInfo[0]['sa5'])){ $disableinput5='readonly'; }else{ $disableinput5='';} 
                  ?>
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access2; ?>>
                  <?php if(in_array('sa1',$project_info)){ ?>
                  <div class="col">
                     <label for="sa1" class="col-form-label">Email Send1:</label>
                     <div class="input-group date" id="" data-target-input="nearest">
                       <input type="date" class="form-control form-control-sm datetimepicker-input" data-target="#datetimepicker2" id="sa1" name="sa1" placeholder="From Date" value="<?php if(!empty($allInfo[0]['sa1'])) { echo date("Y-m-d", strtotime($allInfo[0]['sa1'])); }else{ echo ''; }?>" tabindex="49" max="<?php echo date('Y-m-d');?>" <?= $disableinput1; ?>/>
                  ...
                  <div class="col">
                     <label for="sa2" class="col-form-label">Email Send2:</label>
                     <div class="input-group date" id="" data-target-input="nearest">
                        <input type="date" class="form-control form-control-sm datetimepicker-input" data-target="#datetimepicker3" id="sa2" name="sa2" placeholder="From Date" value="<?php if(!empty($allInfo[0]['sa2'])) { echo date("Y-m-d", strtotime($allInfo[0]['sa2'])); }else{ echo ''; }?>" tabindex="50" max="<?php echo date('Y-m-d');?>" <?= $disableinput2; ?>/>
               ...
               <?php 
                  $div_count=div_access($project_info,array('sa3','sa4','sa5'));
                  $access2 = ($div_count < 1) ? "style='display:none;'" :  '' ; 
                  ?>
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access2; ?>>
                  ...
                  <div class="col">
                     <label for="sa3" class="col-form-label">Email Send3:</label>
                     <div class="input-group date" id="" data-target-input="nearest">
                        <input type="date" class="form-control form-control-sm datetimepicker-input" data-target="#datetimepicker4" id="sa3" name="sa3" placeholder="From Date" value="<?php if(!empty($allInfo[0]['sa3'])) { echo date("Y-m-d", strtotime($allInfo[0]['sa3'])); }else{ echo ''; }?>" tabindex="51" max="<?php echo date('Y-m-d');?>" <?= $disableinput3; ?>/>
                  ...
                  <div class="col">
                     <label for="sa4" class="col-form-label">Email Send4:</label>
                     <div class="input-group date" id="" data-target-input="nearest">
                        <input type="date" class="form-control form-control-sm datetimepicker-input" data-target="#datetimepicker5" id="sa4" name="sa4" placeholder="From Date" value="<?php if(!empty($allInfo[0]['sa4'])) { echo date("Y-m-d", strtotime($allInfo[0]['sa4'])); }else{ echo ''; }?>" tabindex="52" max="<?php echo date('Y-m-d');?>"  <?= $disableinput4; ?>/>
               ...
               <?php 
                  $div_count=div_access($project_info,array('sa5'));
                  $access2 = ($div_count < 1) ? "style='display:none;'" :  '' ; 
                  ?>
               <div class="row g-3 align-items-center justify-content-md-center" <?= $access2; ?>>
                  ...
                  ?>
                  <div class="col">
                     <label for="sa5" class="col-form-label">Linkedin Request:</label>
                     <div class="input-group date" id="" data-target-input="nearest">
                   <input type="date" class="form-control form-control-sm datetimepicker-input" data-target="" id="sa5" name="sa5" placeholder="From Date" value="<?php if(!empty($allInfo[0]['sa5'])) { echo date("Y-m-d", strtotime($allInfo[0]['sa5'])); }else{ echo ''; }?>"  max="<?php echo date('Y-m-d');?>"  tabindex="53" <?= $disableinput5; ?>   />
                     </div>
                  </div>
                  <?php } ?>
               </div>
               <div id="valid_error" style="margin-top: 7px;">
               </div>
               <ul class="nav nav-tabs" id="myTab" role="tablist" style="margin-top:15px;">
                  <li class="nav-item" role="presentation">
                     <button style='font-size:12px' class="nav-link active" id="company-tab" data-bs-toggle="tab" data-bs-target="#company" type="button" role="tab" aria-controls="company" aria-selected="true"><?=  (!empty($allInfo[0]['company_name'])) ?  $allInfo[0]['company_name'] : ''  ?><?=  (!empty($staff_list)) ?  ' ('.count($staff_list).')' : '(0)' ?></button>
                  </li>
                  <li class="nav-item" role="presentation">
                     ...
                     <div class="tab-pane fade" id="project" role="tabpanel" aria-labelledby="project-tab">
                        <div class='table-responsive' style='height:230px;font-size:12px'>
                           <table class="table table-hover table-bordered table-sm p-0 m-0" width="100%" cellspacing="0" id="project_table">
                              ...
                              <tr class="" <?php if($allstaffinfo_val['received_company_name'] == $allInfo[0]['company_name']){ ?>style="background: yellow;" <?php } ?>>
                                    ...
                                    <div class="container-fluid" >
                                       <div style="overflow-y: auto;">
                                          <table id="doc_list_datatable" class="table table-striped table-bordered data-table"  cellspacing="0" width="100%">
                                             <thead>
                                                <tr>
                                                   <th class="ab" style="font-size:15px !important;"> Disposition</th>
         ...
         <div class="row row1">
            ...
            <div class="col">
               <div class="alert alert-warning text-center p-1">
                  ...
                  <?php } ?>
                  <?php if($userinfo == 3 || $userinfo == 8 || $userinfo == 1){?>
                  <div class="row g-3 align-items-center justify-content-md-center" >
                     <?php 
      ...
      $(document).ready(function() {
       $.ajax({
           type: "POST",
           url: '<?php echo base_url(); ?>Projects/getvoicedisposition',
           dataType: 'json',
           success: function(response) {
               console.log(response);
               $.each(response, function (i, value) {

                if(value.id == voice_staff_disposition1)
                {
                  //$('#voice_staff_disposition').select2().val(value.id).trigger('change'); 
                  var $option = $("<option selected></option>").val(value.id).text(value.voice_dispositions);
                  $('#voice_staff_disposition').append($option).trigger('change');
       ...
       if (Notification.permission !== "granted") {
        ...
        var simpletable = $('#example').DataTable({
            bAutoWidth: false, 
            aoColumns : [
               { sWidth: '5%' },
               { sWidth: '5%' },
            ...
            'ajax': {
               'url': "<?= base_url() ?>Projects/get_callback_record",
               'method': "POST",
               'dataType':'json',
               "data": function (data) {
                  data.from_date = $('#followup_from_date1').val();
                  data.to_date = $('#followup_to_date1').val();
                  data.staff_id = $('#staff_id').val();
         ...
         $("#followup_from_date1").change(function(){
            simpletable.ajax.reload(null, false); //just reload table
         });
         
         $("#followup_to_date1").change(function(){
            simpletable.ajax.reload(null, false); //just reload table
         });
