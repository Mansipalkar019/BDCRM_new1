    ...
    class Projects extends CI_Controller
    {
            ...
            if ($this->form_validation->run() == true) {
                ...
                if (!empty($_FILES['uploaded_file']['name'])) {
                    ...
                    for ($i = 1; $i < count($file_data); $i++) {
                        $lower = trim(strtolower($file_data[$i][10]));
                        if(!empty($lower)){
                        ...
                        if ($check < '0' && !empty($db_country_name)) {
                            $valid = 0;
                            $line_number = $i + 1;
                            $comment = 'Invalid country on line' . ' ' . $line_number;
                            $data = array('error' => $comment, 'class' => 'danger','wrong'=>$lower);
                            $error[] = $data;
                        }
                    }
                   ...
                   if($valid > 0) {
                    for ($i = 1; $i < count($file_data); $i++) {
                        ...
                        $fInfo = (!empty($file_data[$i][12])) ? $this->getCountryInfoByName($file_data[$i][12]) : '' ;
                        $industry_name =  $file_data[$i][4];
                        $industry_id = (!empty($industry_name)) ? $this->getindustryInfo($industry_name) : "" ;
                        $salutation_name=$file_data[$i][1];
                        $salutation = (!empty($salutation_name)) ? $this->getSalutationInfo($salutation_name) : "" ;
                        //echo $salutation;die();
                        $voice_disposition =  $file_data[$i][20];
                        //echo $file_data[$i][14];die();
                        $voice_disposition_id = (!empty($voice_disposition)) ? $this->getdisposition($voice_disposition) : "" ;
                        //echo $voice_disposition_id;die();
                        $voice_staff_disposition =  $file_data[$i][21];
                        $voice_staff_disposition_id = (!empty($voice_staff_disposition)) ? $this->getsubdisposition($voice_staff_disposition) : "" ;
                        
                        $file_datas[$i]['received_company_name'] = $file_data[$i][0];
                        $file_datas[$i]['company_name'] = $file_data[$i][0];
                        $file_datas[$i]['suffix'] =$salutation;
                        $file_datas[$i]['first_name'] =  $file_data[$i][2];
                        $file_datas[$i]['provided_job_title'] = $file_data[$i][3];
                        $file_datas[$i]['industry'] = $industry_id;
                        $file_datas[$i]['assumed_email'] =  $file_data[$i][5];
                        $file_datas[$i]['provided_staff_email'] = $file_data[$i][6];
                        $file_datas[$i]['alternate_number'] = $file_data[$i][7];
                        $file_datas[$i]['staff_direct_tel'] = $file_data[$i][8];
                        $file_datas[$i]['provided_direct_tel'] = $file_data[$i][9];
                        $file_datas[$i]['tel_number'] = $file_data[$i][10];
                        $file_datas[$i]['staff_url'] = $file_data[$i][11];
                        ...
                        $file_datas[$i]['state_county'] = $file_data[$i][14];
                        $file_datas[$i]['city'] = $file_data[$i][15];
                        $file_datas[$i]['no_of_emp'] = $file_data[$i][16];
                        $file_datas[$i]['address1'] = $file_data[$i][17];
                        if(!empty($file_data[$i][18]))
                        {
                           $sa5=date_create(str_replace("/","-",$file_data[$i][18]));
                           $file_datas[$i]['sa5'] = date_format($sa5,"Y-m-d H:i:s");
                        }else{
                          $file_datas[$i]['sa5'] = '';  
                        }
                       
                        $last_call_date=date_create($file_data[$i][19]);
                        $file_datas[$i]['last_call_date'] = date_format($last_call_date,"Y-m-d H:i:s");
                        $file_datas[$i]['voice_disposition'] = $voice_disposition_id;
                        $file_datas[$i]['voice_staff_disposition'] = $voice_staff_disposition_id;
                        $file_datas[$i]['last_remark'] = $file_data[$i][22];
                        if(!empty($file_data[$i][23]))
                        {
                            $sa1=date_create(str_replace("/","-",$file_data[$i][23]));
                            $file_datas[$i]['sa1'] = date_format($sa1,"Y-m-d H:i:s");
                        }else{
                            $file_datas[$i]['sa1']='';
                        }

                        if(!empty($file_data[$i][24]))
                        {
                             $sa2=date_create(str_replace("/","-",$file_data[$i][24]));
                            $file_datas[$i]['sa2'] = date_format($sa2,"Y-m-d H:i:s");
                        }else{
                            $file_datas[$i]['sa2']='';
                        }
                        
                        if(!empty($file_data[$i][25]))
                        {
                            $sa3=date_create(str_replace("/","-",$file_data[$i][25]));
                            $file_datas[$i]['sa3'] = date_format($sa3,"Y-m-d H:i:s");
                        }else{
                            $file_datas[$i]['sa3']='';
                        }

                        if(!empty($file_data[$i][26]))
                        {
                            $sa3=date_create(str_replace("/","-",$file_data[$i][26]));
                            $file_datas[$i]['sa4'] = date_format($sa3,"Y-m-d H:i:s");
                        }else{
                            $file_datas[$i]['sa4']='';
                        }
                       
                        $file_datas[$i]['created_date'] = date('Y-m-d H:i:s');

                        
                        // Added Algo For the Remarks 
                        for($n=27; $n<60;$n++){
                          $remakrs = $file_data[$i][$n];
                          $remakrs_info[$i][] = $remakrs;
                        }
                         $file_datas[$i]['remarks_data'] = $remakrs_info[$i];
                         
                         $new[] = $file_datas[$i];
                      
                    } 
                    //echo "<pre>";print_r($new[0]);die();
                                ...
                                if($addProjectinputfields){
                                    ...
                                    //echo "<pre>";print_r($new);die();
                                       foreach ($new as $key => $val) {
                                        ...
                                        if($val['received_company_name']!=''){

                                            $remarks_history = (array_filter($val['remarks_data'], fn($value) => !is_null($value) && $value !== ''));
                                            unset($val['remarks_data']);
                                            unset($val['last_call_date']);
                                            unset($val['last_remark']);
                                            unset($val['Follow_up_Call_Date']);
                                            ...
                                            if(!empty($remarks_history)){
                                                foreach ($remarks_history as $key => $Rvalue) {
                                                    $remrks_data = $Rvalue;
                                                    $str_arr = explode ("|", $remrks_data);
                                                    $timeStamp = date("Y-m-d", strtotime($str_arr[0]));   
                                                   $insert_info = array('voice_staff_disposition '=>$val['voice_staff_disposition'],'co_caller_disposition'=>$val['voice_disposition'],'staff_id'=>$mid,'caller_remark'=>$str_arr[1],'ondate'=>date("Y-m-d"),'created_at'=>$timeStamp);
                                                    $this->model->insertData('caller_history', $insert_info);
                                                }
                                            }
                ...
                $errors[0]['error'] = validation_errors();
                $errors[0]['class']="Danger";
                $data['error'] = $errors;
                $this->session->set_flashdata("error", $data);
        ...
        //                 $file_datas[$i]['provided_job_title'] = $file_data[$i][3];
        //                 $file_datas[$i]['updated_job_title'] = $file_data[$i][3];
        ...
        //                 $file_datas[$i]['staff_email'] = $file_data[$i][18];
        ...
        //                                             $str_arr = explode ("|", $remrks_data);
        //                                             $timeStamp = date("Y-m-d", strtotime($str_arr[0]));   
        //                                             $insert_info = array('staff_id'=>$mid,'caller_remark'=>$str_arr[1],'ondate'=>date("Y-m-d"),'created_at'=>$timeStamp);
        //                                             $this->model->insertData('caller_history', $insert_info);
        //                                         }
        //                                     }
        ...
        public function getindustryInfo($industry_name){
           return $industry_id =  $this->Projects_model->getindustryInfoByName($industry_name);
        }

        public function getSalutationInfo($salutation_name){
            return $salutation_id =  $this->Projects_model->getSalutationInfoByName($salutation_name);
         }
        
        public function getdisposition($disposition){
            
            return $disposition1 =  $this->Projects_model->getdispositions($disposition);
           
         }

        public function getsubdisposition($subdisposition){
            return $subdisposition1 =  $this->Projects_model->getsubdispositions($subdisposition);
         }

        public function getvoicedisposition() {
    
            $data=$this->model->selectWhereData('bdcrm_staff_voice_dispositions', array('status' => '1'),array('*'),false);
        ...
        public function DeleteProjects($project_id){
            ...
            $deactivateProjects1 = $this->model->updateData("bdcrm_uploaded_feildss", array('status'=>0), array('project_id' => $project_id));
        ...
        public function getsuffix($suffix){
            $country_name = strtolower($suffix);
            $sql = "SELECT id,phonecode,region FROM `bdcrm_countries` WHERE lower(name) = '$country_name' AND status='1'"; 
            $query = $this->db->query($sql);
            return $row = $query->row_array();
    }  
        ...
        public function my_projects($pid,$rid,$cmp_name='')
        {
            ...
            $data['VoiceDispos'] = $this->Projects_model->getstaffvoicedisbytasktype($data['allInfo'][0]['id'],$data['allInfo'][0]['task_type'],$data['allInfo'][0]['disposition_status'],$data['allInfo'][0]['main_voice_staff_disposition'],$data['allInfo'][0]['caller_has_replaced'],$data['allInfo'][0]['first_name'],$data['allInfo'][0]['last_name'],$data['allInfo'][0]['voice_staff_disposition']);
            ...
            $data['staff_list']=$this->Projects_model->getStaffInfoDetails($project_id,$data['allInfo'][0]['company_name']);
            ...
            // if($this->session->userdata('id')==21){
            //       echo "<pre>";
            //       print_r($data);
            //       die;
            // }
            ...
            foreach($insert_record as $k =>$val){
             ...
             if(!empty($ProjectInfo)){
                 foreach ($ProjectInfo as $ProjectInfo_key => $ProjectInfo_row) {
                         $completed_status_count = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('updated_status'=>'Updated','company_name'=>$ProjectInfo_row['received_company_name']),array('count(updated_status) as completed_updated_status'));
        ...
        public function update_company_details()
        {
            ...
            $caller_company_remark=$this->input->post('caller_company_remark');
            ...
            $followup_date=$this->input->post('from_date1');
            $generic_mail=$this->input->post('generic_mail');
            ...
            $company_details=array(
                ...
                'provided_direct_tel'=>$staff_direct_tel,
                'staff_direct_tel'=>$staff_mobile,
            ...
            { 
               $check_history=$this->model->selectWhereData('caller_history',array('voice_staff_disposition' => 
                                $voice_staff_disposition,'created_by'=>$this->session->userdata('id'),'firstname ='=>$first_name,'created_at >=' =>date("Y-m-d H:i:s")),array('voice_staff_disposition','created_by','caller_remark','created_at'),false);
                 if(empty($check_history)){
                    // if(!empty($staff_note) && !empty($company_voice_disposition) && !empty($voice_staff_disposition ))
                    // {
                    //       $this->model->insertData('caller_history',array('voice_staff_disposition'=>$voice_staff_disposition,'caller_remark'=>$staff_note,'firstname'=>$first_name,'lastname'=>$last_name,'created_at'=>date('Y-m-d H:i:s'),'created_by'=>$this->session->userdata('id'),'ondate'=>date('Y-m-d'),'staff_id'=>$staff_id));
                    // }
                    if(!empty($staff_note) && !empty($company_voice_disposition) && !empty($voice_staff_disposition ))
                    {
                        $check_voice_staff_dis_exist= array(16,17,56,43,46,47,52,58,89);
                        if(in_array($voice_staff_disposition, $check_voice_staff_dis_exist)){
                           if(!empty($followup_date)){
                          $this->model->insertData('caller_history',array('voice_staff_disposition'=>$voice_staff_disposition,'co_caller_disposition' => $company_voice_disposition,'caller_remark'=>$staff_note,'firstname'=>$first_name,'lastname'=>$last_name,'created_at'=>date('Y-m-d H:i:s'),'created_by'=>$this->session->userdata('id'),'ondate'=>date('Y-m-d'),'staff_id'=>$staff_id));
                        }
                        }else{
                         $this->model->insertData('caller_history',array('voice_staff_disposition'=>$voice_staff_disposition,'co_caller_disposition' => $company_voice_disposition,'caller_remark'=>$staff_note,'firstname'=>$first_name,'lastname'=>$last_name,'created_at'=>date('Y-m-d H:i:s'),'created_by'=>$this->session->userdata('id'),'ondate'=>date('Y-m-d'),'staff_id'=>$staff_id));
                        }
                ...
                $check_follow_up_history=$this->model->selectWhereData('followup_date_history',array('project_id' => 
                                $project_id,'staff_id'=>$staff_id,'date_time'=>$followup_date),array('project_id','date_time'),false);
                // if(empty($check_follow_up_history)){
                //     $updatestatus=array('status'=>'0');
                    // $this->model->updateData('followup_date_history',$updatestatus,array('status'=>'1','project_id' => 
                    //             $project_id,'staff_id'=>$staff_id));
                     $check_voice_staff_dis_exist= array(16,17,56,43,46,47,52,58,59);
                     if(in_array($voice_staff_disposition, $check_voice_staff_dis_exist)){
                        if(!empty($followup_date)){
                         $check_followup=$this->model->selectWhereData('followup_date_history',array('project_id' => 
                                $project_id,'date_time'=>$followup_date,'staff_id ='=>$staff_id,'created_by'=>$this->session->userdata('id'),'created_at'=>date('Y-m-d H:i:s')),array('date_time'),false);
                        if(empty($check_followup)){
                        $this->model->insertData('followup_date_history',array('project_id'=>$project_id,'date_time'=>$followup_date,'staff_id'=>$staff_id,'created_by'=>$this->session->userdata('id'),'created_at'=>date('Y-m-d H:i:s')));
                            }
                        }
                    ...
                    if($user_list_last_key == $user_list_key){
                        if(!empty($company_name)){
                            foreach ($company_name as $company_name_key => $company_name_row) {
                                ...
                                $company_name_id_info = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('company_name' => 
                                $company_name_row,'project_id'=>$project_id),array('id','project_id'),false);
                                //echo "<pre>";print_r($company_name_id_info);die();
                                    ...
                                    foreach ($company_name_id_info as $company_name_id_info_key => $company_name_id_info_row) {
                                        ...
                                        {   
                                            ...
                                            foreach($check_assigned_task as $key => $value)
                                            {
                                                ...
                                                if($this->session->userdata('designation_name') == "Superadmin")
                                                {
                                                ...
                                                }else if($this->session->userdata('designation_name') == "Caller Team Leader"){

                                                    $reassignstaff= $this->model->updateData("companywise_allocation",$update_companywise_allocation,array('project_id'=>$value['project_id'],'staff_id'=>$value['staff_id'],'assigned_by => 1 OR assigned_by =>14'));

                                                }else if($this->session->userdata('designation_name') == "Researcher Team Leader"){
                                                    
                                                    $reassignstaff= $this->model->updateData("companywise_allocation",$update_companywise_allocation,array('project_id'=>$value['project_id'],'staff_id'=>$value['staff_id'],'assigned_by => 1 OR assigned_by =>13'));
                                                }
...
function excel_download()
        {
           ...
           $fdata=array();
           foreach($totalData as $data_key =>$data_value)
           {
               $sql1="SELECT caller_history.staff_id,GROUP_CONCAT(caller_history.caller_remark SEPARATOR '#') as caller_remark,GROUP_CONCAT(caller_history.created_at SEPARATOR '#') as last_remark_date FROM `caller_history`  left join bdcrm_staff_voice_dispositions as bsvd on caller_history.voice_staff_disposition = bsvd.id WHERE caller_history.staff_id='".$data_value['staff_id']."' ORDER BY caller_history.ondate ASC";  
               $query1 = $this->db->query($sql1);
               $datas=  $query1->row_array();
               $fdata[$data_key]=  $datas;
              
           } 
           foreach($totalData as $data_key1 =>$data_value1)
           {
               if(!empty($fdata[$data_key1]))
               {
                   $val2 = $fdata[$data_key1];
                   $totalData[$data_key1] = $data_value1 + $val2;
               }else{
                   $val2 = $fdata[$data_key1];
                   $totalData[$data_key1] =$data_value1;
               }
           ...
           $objPHPExcel->getActiveSheet()->SetCellValue('C1', 'Staff Name'); 
           $objPHPExcel->getActiveSheet()->SetCellValue('D1', 'Job title');   
           $objPHPExcel->getActiveSheet()->SetCellValue('E1', 'Company Industry');
           $objPHPExcel->getActiveSheet()->SetCellValue('F1', 'Assumed Email');
           $objPHPExcel->getActiveSheet()->SetCellValue('G1', 'Email Address');
           $objPHPExcel->getActiveSheet()->SetCellValue('H1', 'Direct Tel');
           $objPHPExcel->getActiveSheet()->SetCellValue('I1', 'Company Tel');   
           $objPHPExcel->getActiveSheet()->SetCellValue('J1', 'Mobile');  
           $objPHPExcel->getActiveSheet()->SetCellValue('K1', 'Alternate Number');  
           $objPHPExcel->getActiveSheet()->SetCellValue('L1', 'Staff source Link');   
           $objPHPExcel->getActiveSheet()->SetCellValue('M1', 'Country');   
           $objPHPExcel->getActiveSheet()->SetCellValue('N1', 'State County');   
           $objPHPExcel->getActiveSheet()->SetCellValue('O1', 'City');   
           $objPHPExcel->getActiveSheet()->SetCellValue('P1','Region');    
           $objPHPExcel->getActiveSheet()->SetCellValue('Q1','Company Size'); 
           $objPHPExcel->getActiveSheet()->SetCellValue('R1', 'Criteria');
           $objPHPExcel->getActiveSheet()->SetCellValue('S1', 'Linkedin connection');  
           $objPHPExcel->getActiveSheet()->SetCellValue('T1', 'Last call Date');     
           $objPHPExcel->getActiveSheet()->SetCellValue('U1', 'Disposition');
           $objPHPExcel->getActiveSheet()->SetCellValue('V1', 'Sub Disposition');   
           $objPHPExcel->getActiveSheet()->SetCellValue('W1', 'Current Remarks');  
           $objPHPExcel->getActiveSheet()->SetCellValue('X1', 'Email Sent Date1');
           $objPHPExcel->getActiveSheet()->SetCellValue('Y1', 'Email Sent Date2');
           $objPHPExcel->getActiveSheet()->SetCellValue('Z1', 'Email Sent Date3');
           $objPHPExcel->getActiveSheet()->SetCellValue('AA1', 'Email Sent Date4');
           $objPHPExcel->getActiveSheet()->SetCellValue('AB1', 'Follow-up Call Date'); 
           $objPHPExcel->getActiveSheet()->SetCellValue('AC1', 'Created Date');
           $objPHPExcel->getActiveSheet()->SetCellValue('AD1', 'Assigned Date');  
           $objPHPExcel->getActiveSheet()->SetCellValue('AE1', 'Assigned By');  
           $objPHPExcel->getActiveSheet()->SetCellValue('AF1', 'Assigned To');   
            
         
           $col11 = 32;
           $row = 1;
            for($i=1;$i<=30;$i++) {
                // $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col11,$row,'Disposition Status'.$i);
                // $col11++;
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col11,$row,'Caller Remark'.$i);
                $col11++;
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($col11,$row,'Date'.$i);
                $col11++;
            }
            //header ends
           ...
           foreach($totalData as $totalData_key => $totalData_row)
           {
            ...
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount,$i);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['company_name']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['first_name']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['provided_job_title']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['industry_type']);
            $coll12++; 
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['assumed_email']);
            $coll12++;    
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['provided_staff_email']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['provided_direct_tel']); 
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['tel_number']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['staff_direct_tel']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['alternate_number']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['staff_source_url']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['updated_country']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['state_county']);
            $coll12++;
            // $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['time_zone']);
            // $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['city']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['region']);
            $coll12++;
            // $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['postal_code']);
            // $coll12++;
            // $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['country_code']); 
            // $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['no_of_emp']); 
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['address1']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['sa5']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['caller_hist_remark_date']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['company_voice_disposition']);   
            $coll12++;  
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['caller_staff_disposition']);  
            $coll12++; 
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['caller_hist_remark']); 
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['sa1']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['sa2']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['sa3']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount, $totalData_row['sa4']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['follow_up_date']); 
            $coll12++;   
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['created_date']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['assigned_at']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['assigned_by_date']);
            $coll12++;
            $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['reassigned_to']); 
            $coll12++;
          
            $remark=explode('#',$totalData_row['caller_remark']);
            $data=explode('#',$totalData_row['last_remark_date']);
            //$disposition_status=explode(',',$totalData_row['disposition_status']);
            $fdata=array();
            foreach($remark as $remark_key =>$remark_val)
            {
                $fdata[$remark_key]['staff_id']=$totalData_row['staff_id'] ;
                $fdata[$remark_key]['remark']=$remark_val ;
                $fdata[$remark_key]['date']=$data[$remark_key];
               // $fdata[$remark_key]['dispo_status']=$disposition_status[$remark_key];
            }
            
            foreach($fdata as $fdata_key =>$fdata_val)
            {
                // $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $fdata_val['dispo_status']); 
                // $coll12++;
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $fdata_val['remark']); 
                $coll12++;
                $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $fdata_val['date']); 
                $coll12++;
            }
        ...
        //     $total = 0;
        //     if(!empty($_POST)){
        //         $_POST['record_type']="projectinfonew";
        ...
        //     }
        //             if($_POST['project_list'] == 'projectinfonew')
        //             {
        ...
        //                 $new_sql=$sql;
        //                 $id= $this->input->post('id');
        //                 $ProjectInfo =$this->Projects_model->getProjectInfo1($sql,$id,$records_count,$status,$user_ids);
        //                return $data = array('project_info'=>$ProjectInfo,'sql'=>$new);
        //             }
        ...
        public function ProjectInfoNew($id=''){
            ...
            if(!empty($_POST)){
                ...
                $data['ProjectInfo'] = $this->getfilterData($_POST)['project_info'];
                //echo "<pre>";print_r($data['ProjectInfo']);die();
                $data['project_id'] = $_POST['id'];
                $data['sqlData'] = "SELECT * FROM TABLE WHERE ".$this->getfilterData($_POST)['sql']; 
            }else{
              //echo "2";die();
    ...
    public function insert_noresult_row()
        {
            ...
            $company_received=$this->input->post('company_received');
            //echo $company_received;die();
            ...
            if($this->session->userdata('designation_id') == 8 || $this->session->userdata('designation_id') == 1){
                ...
                $check_is_added = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('caller_has_replaced' => $staff_id,'activity_type'=>'1'),array('*'),false);
                $caller_has_replaced1 = (!empty($check_is_added)) ? '' : '01' ;
                $co_web_disposition=" ";
            
            if($company_received != $get_exisiting_row[0]['company_name'])
            {
                $new_company=$company_received;
            }else
            {
                $new_company=$get_exisiting_row[0]['company_name'];
            }
            $new_row_staff_details=array(
                ...
                'caller_has_replaced1'=>$caller_has_replaced1,
                'company_name'=>$get_exisiting_row[0]['company_name'],
                'activity_type'=>'1',
                'received_company_name'=>$get_exisiting_row[0]['company_name'],
                ...
                'web_disposition'=>$co_web_disposition,
    ...
    public function insert_replacement_row()
        {
            ...
            $company_alloc_exisiting_row = $this->model->selectWhereData('companywise_allocation',array('staff_id' => $staff_id,'project_id'=>$project_id),array('*'),false);
             //if($this->session->userdata('designation_id') == 3){
                ...
                $caller_has_replaced=$staff_id;
                $check_is_added = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('caller_has_replaced' => $staff_id,'activity_type'=>3),array('*'),false);
                $caller_has_replaced1 = (!empty($check_is_added)) ? '' : '1' ;
                $co_web_disposition=" ";
            //}
        ...
        public function insert_staff_row()
        {
            ...
            if($this->session->userdata('designation_id') == 8 || $this->session->userdata('designation_id') == 1){
                $this->model->updateData("bdcrm_uploaded_feildss", array('web_staff_disposition'=>$web_staff_disposition,'voice_staff_disposition'=>$voice_staff_disposition), array('id' =>$staff_id));
                $caller_has_replaced=$staff_id;
                $check_is_added = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('caller_has_replaced' => $staff_id,'activity_type'=>2),array('*'),false);
                $caller_has_replaced1 = (!empty($check_is_added)) ? '' : '01' ;
                $co_web_disposition=" ";
        ...
        public function insert_acquired_row()
        {
            ...
            //     $has_replaced1 = $this->Projects_model->MaxStaffId($has_replaced);
            //     $co_web_disposition=$get_exisiting_row[0]['web_disposition'];
            if($this->session->userdata('designation_id') == 8 || $this->session->userdata('designation_id') == 1){
                $this->model->updateData("bdcrm_uploaded_feildss", array('web_staff_disposition'=>$web_staff_disposition,'voice_staff_disposition'=>$voice_staff_disposition), array('id' =>$staff_id));
                $caller_has_replaced=$staff_id;
                $has_replaced=$get_exisiting_row[0]['has_replaced'];
                $voice_staff_disposition = '2';
                $caller_has_replaced1 = $this->Projects_model->MaxStaffId($caller_has_replaced);
                $co_web_disposition=" ";
        ...
        function getcallerrecord()
        {
            ...
            $search_text = $_POST['search']['value'];   
            $totalData=$this->Projects_model->getvoicerecord($from_date,$to_date,$rowno,$rowperpage,$search_text,$first_name,$last_name,$staff_id);   
            $count_filtered=$this->Projects_model->getvoicerecord_count_filtered($from_date,$to_date,$rowno,$rowperpage,$search_text,$first_name,$last_name,$staff_id);
            $count_all = $this->Projects_model->getvoicerecord_count_all($from_date,$to_date,$rowno,$rowperpage,$search_text,$first_name,$last_name,$staff_id);
            $data_array=array();
            foreach($totalData as $category_details_key => $data_row)
            {
              
                $nestedData=array();
                    $nestedData[] = $data_row['caller_disposition'];  
                    $nestedData[] = $data_row['voice_dispositions'];
                    $nestedData[] = $data_row['caller_remark'];
                    $nestedData[] = date('d-m-Y H:i:s',strtotime($data_row['created_at']));   
                    $data_array[] = $nestedData;
        ...
        {   
            $data['calendarevents']=$this->Projects_model->getcalendarevents(); 
            $data['results_count']=count($data['calendarevents']); 
            $data['all_users'] = $this->model->getData('users',array('status'=>'1'));
            $data['main_content'] = "projects/calendar"; 
            $this->load->view("includes/template", $data);
        }

        public function calendar_search(){
            $data1 = $this->input->get('data', TRUE);
            ...
            $data['all_users'] = $this->model->getData('users',array('status'=>'1'));
            $data['calendarevents']=$this->Projects_model->searchcalendarevents($from_date,$to_date,$user_id); 
            $data['results_count']=count($data['calendarevents']); 
        ...
        // { 
        //     $this->load->model('Projects_model');
        //     $getnotification= $this->Projects_model->getnotification(); 
        ...
        //     foreach($getnotification as $getnotificationkey => $getnotificationval)
        //     {

        //         // echo "<pre>";
        //         // print_r($getnotificationval); 


        //          echo $notify_me = $getnotificationval['date_time'];
        //           $server_date_time = date('d-m-Y H:i:s');
        //         echo $reserve_from_time_10 = date('d-m-Y H:i:s',strtotime($notify_me .'-10 minutes'));

        //          if('07-02-2023 11:58' == "07-02-2023 11:58"){
        //         if(!empty($getnotificationval['company_name'])){ $value=$getnotificationval['company_name']; }else{ $value= $getnotificationval['received_company_name']; }
        //         $explodes=explode(' ',$getnotificationval['date_time']);
        //         $cmp_time= date("H:i", strtotime($explodes[1]));
                
        //         //$reserve_from_time_5 = date('H:i',strtotime($cmp_time .'-5 minutes'));
        //         $links=base_url()."Projects/my_projects/".base64_encode($getnotificationval['project_id']).'/'.base64_encode($getnotificationval['staff_id']).'/'.base64_encode($value);
        //             echo json_encode(array(
        //             'show' => true,
        //             'title' => 'Upcoming FollowUp1',
        //             'notification' => "You have an upcoming followup with  at: " . date('d-m-Y h:i:s', strtotime($getnotificationval['date_time'])),
        //             'link' => $links
        //             ));
               
        //     }else{
                 
        //         echo json_encode(array('show' => false));
        //     }
        // }
        //  }else{
        //     echo $server_date_time = date('d-m-Y H:i:s');
        //  }
        ...
        // }
         ...
         public function notify(){
            $this->load->model('Projects_model');
            $getnotification= $this->Projects_model->getnotification()[0];
            $current_date=date('H:i');
            $reserve_from_time_5 = date('Y-m-d H:i:s',strtotime($current_date_time .'+5 minutes'));
            $links=base_url()."Projects/my_projects/".base64_encode($getnotification['project_id']).'/'.base64_encode($getnotification['staff_id']);
            if(!empty($getnotification)){
                 echo json_encode(array(
                    'show' => true,
                    'title' => 'Upcoming FollowUp1',
                    'notification' => "You have an upcoming followup with  at:".$reserve_from_time_5,
                    'link' => $links
                    ));
         ...
         public function advanc_search()
        {
            
            $data['ProjectInfo'] = $this->Projects_model->get_staff_info1();
           $fdata=array();
            foreach($data['ProjectInfo'] as $data_key =>$data_value)
            {
                $sql1="SELECT voice_staff_disposition,caller_remark,created_at as last_remark_date FROM `caller_history` WHERE staff_id='".$data_value['staff_id']."' AND id=(SELECT MAX(id) FROM caller_history WHERE staff_id='".$data_value['staff_id']."')";
               
                $query1 = $this->db->query($sql1);
                $datas=  $query1->row_array();
                $fdata[$data_key]=  $datas;
            }
            foreach($data['ProjectInfo'] as $data_key1 =>$data_value1)
            {
                if(!empty($fdata[$data_key1]))
                {
                    $val2 = $fdata[$data_key1];
                    $data['ProjectInfo'][$data_key1] = $data_value1 + $val2;
                }else{
                    $val2 = $fdata[$data_key1];
                    $data['ProjectInfo'][$data_key1] =$data_value1;
                }
              
                
            }
            $data['main_content'] = "projects/advanc_search"; 
            $this->load->view("includes/template", $data);
        }

         function get_callback_record()
        {
            $data[] = json_encode($_POST);  
            $from_date = $_POST['from_date'];
            $to_date = $_POST['to_date'];
            ...
            $rowperpage = $_POST['length'];
            $search_text = $_POST['search']['value'];   
            $totalData=$this->Projects_model->getcallbackrecord($from_date,$to_date,$rowno,$rowperpage,$search_text,$staff_id); 
            $count_filtered=$this->Projects_model->get_callback_count($from_date,$to_date,$rowno,$rowperpage,$search_text,$staff_id);
            $count_all = $this->Projects_model->get_callback_count($from_date,$to_date,$rowno,$rowperpage,$search_text,$staff_id);
            $data_array=array();
            foreach($totalData as $category_details_key => $data_row)
            {
                 
                if($data_row['status'] == "true"){ $val='<span class="badge bg-success" style="padding:7px;"><span class=""></span></span>'; $bgcolor='<div style="background: green;color: white;text-align: center;font-weight:600;">'.$data_row['first_name'].' '.$data_row['last_name'].'</div>'; }else{ $val='<span class="badge bg-danger" style="padding:7px;"><span class=""></span></span>'; $bgcolor='<p style="background: red;color: white;text-align: center;font-weight:600;">'.$data_row['first_name'].' '.$data_row['last_name'].'</p>'; }
                $url='<span><a href="'.base_url().'Projects/my_projects/'.base64_encode($data_row['project_id']).'/'.base64_encode($data_row['id']).'/'.base64_encode($data_row['company_name']).'" target="_blank" style="text-decoration: none;">
                 <i class="glyphicon glyphicon-download-alt invoice_view" aria-hidden="true" 
                  ></i>'.$bgcolor.'</a></span>';
               if($data_row['status'] == "true"){ $val1='<p style="background: green;color: white;text-align: center;font-weight:600;">'.$data_row['first_name'].' '.$data_row['last_name'].'</p>'; }else{ $val1=$url; }
                $nestedData=array();
                $nestedData[] = ++$category_details_key;
                $nestedData[] = $data_row['date_time'];
                $nestedData[] = $val1;
                $nestedData[] = $data_row['company_name'];
                $nestedData[] = $data_row['caller_remark']; 
                $nestedData[] = $val;  
                //$nestedData[] = if($data_row['status'] == true){ $val=''; }else{ };  
                $data_array[] = $nestedData;
         ...
         $output = array(
          ...
          public function bd_master_account()
        {
          
            $data['bd_master_account']=$this->Projects_model->bd_master_account_data(); 
            $data['main_content'] = "projects/bd_master_account"; 
            $this->load->view("includes/template", $data);
        }

        public function bd_master_account1()
        {
          
            $data['bd_master_account']=$this->Projects_model->bd_master_account_data(); 
            $fdata=array();
            foreach($data['bd_master_account'] as $data_key =>$data_value)
            {
                $sql1="SELECT bsvd.voice_dispositions,caller_history.caller_remark,caller_history.created_at as last_remark_date FROM `caller_history` left join bdcrm_staff_voice_dispositions as bsvd on caller_history   .voice_staff_disposition = bsvd.id WHERE caller_history.staff_id='".$data_value['id']."' AND caller_history.id=(SELECT MAX(id) FROM caller_history WHERE staff_id='".$data_value['id']."')";  
                $query1 = $this->db->query($sql1);
                $datas=  $query1->row_array();
                $fdata[$data_key]=  $datas;
            }
            foreach($data['bd_master_account'] as $data_key1 =>$data_value1)
            {
                if(!empty($fdata[$data_key1]))
                {
                    $val2 = $fdata[$data_key1];
                    $data['bd_master_account'][$data_key1] = $data_value1 + $val2;
                }else{
                    $val2 = $fdata[$data_key1];
                    $data['bd_master_account'][$data_key1] =$data_value1;
                }
       ...
       //  public function check_staff_already_exist($company_name,$first_name,$last_name,$staff_id)
       // {
       //      $sql1="SELECT buf.*, `us`.`username` FROM `bdcrm_uploaded_feildss` as `buf` LEFT JOIN `companywise_allocation` `cal` ON `buf`.`id` = `cal`.`staff_id` LEFT JOIN `users` `us` ON `cal`.`reassigned_to`=`us`.`id` WHERE `buf`.`company_name` = '".$company_name."' AND (`buf`.`first_name` = '".$first_name."' OR `buf`.`last_name` = '".$last_name."') AND `buf`.`id` = '".$staff_id."'";
       //      $query = $this->db->query($sql1);
       //      $data =  $query->result_array(); 
       //      return $data;
       // }

       function caller_remark_his()
       {
           //echo $this->session->userdata('id');
           $data['master_project'] = $this->Projects_model->get_master_project_by_id();
           $data['user_list'] = $this->model->getData('users', array('status' => '1'));
           $data['main_content'] = "projects/caller_remark_his"; 
           $this->load->view("includes/template", $data);
       }
       
        function getcallerhistorys()
       {
           $data[] = json_encode($_POST); 
          // echo "<pre>";print_r($data);die();
           ...
           $rowperpage = $_POST['length'];
           $search_text = $_POST['search']['value'];   
           $totalData=$this->Projects_model->get_callerhis_filter($from_date,$to_date,$rowno,$rowperpage,$search_text,$project_id,$user_lists);   
           
           $count_filtered=$this->Projects_model->get_callerhis_filter_count($from_date,$to_date,$rowno,$rowperpage,$search_text,$project_id,$user_lists);
          
           $count_all = $this->Projects_model->get_callerhis_filter_count_all($from_date,$to_date,$rowno,$rowperpage,$search_text,$project_id,$user_lists);
            //echo "<pre>";print_r($count_all);die();
           $data_array=array();
           foreach($totalData as $category_details_key => $data_row)
           {
               $nestedData=array();
...
//    public function call_history_download()
//    {
...
//       // load excel library
//       $this->load->library('excel');
//       $totalData=$this->Projects_model->download_record($from_date,$to_date,$project_id,$user_lists);  
//      //echo '<pre>'; print_r($totalData); exit;
//       $objPHPExcel = new PHPExcel();
//       $objPHPExcel->setActiveSheetIndex(0);
//       // set Header
//       $objPHPExcel->getActiveSheet()->SetCellValue('A1', 'ID');
//       $objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Project Name');
...
//       $objPHPExcel->getActiveSheet()->SetCellValue('F1', 'Staff Name');     
//       $objPHPExcel->getActiveSheet()->SetCellValue('G1', 'Caller Remark');   
//       $objPHPExcel->getActiveSheet()->SetCellValue('H1', 'Created At');   
...
//        $objPHPExcel->getActiveSheet()->SetCellValue('B' . $rowCount, $totalData_row['project_name']);
//        $objPHPExcel->getActiveSheet()->SetCellValue('C' . $rowCount, $totalData_row['company_name']);
//        $objPHPExcel->getActiveSheet()->SetCellValue('D' . $rowCount, $totalData_row['country_name']);
//        $objPHPExcel->getActiveSheet()->SetCellValue('E' . $rowCount, $totalData_row['region']);
//        $objPHPExcel->getActiveSheet()->SetCellValue('F' . $rowCount, $totalData_row['first_name'].' '.$totalData_row['last_name']);
//        $objPHPExcel->getActiveSheet()->SetCellValue('G' . $rowCount, $totalData_row['caller_remark']);
//        $objPHPExcel->getActiveSheet()->SetCellValue('H' . $rowCount, $totalData_row['created_at']);
//        $objPHPExcel->getActiveSheet()->SetCellValue('I' . $rowCount, $totalData_row['username']);
//        $rowCount++; $i++;
//       }
   
//        $filename = FCPATH . "uploads/callerhistory/call_history_report_".time().".xls";
...
//        $response['url'] = base_url()."uploads/callerhistory/call_history_report_".time().".xls";
...
public function call_history_download()
    ...
    $user_lists=$_POST['user_lists'];
       ...
       $objPHPExcel->getActiveSheet()->SetCellValue('E1', 'Region');
       $objPHPExcel->getActiveSheet()->SetCellValue('F1', 'Staff Name');    
       $objPHPExcel->getActiveSheet()->SetCellValue('G1', 'Last Caller Remark');   
       $objPHPExcel->getActiveSheet()->SetCellValue('H1', 'Last Remark Date');   
       $objPHPExcel->getActiveSheet()->SetCellValue('I1', 'Username');   
       ...
       foreach($totalData as $totalData_key => $totalData_row)
       {
        ...
        $sql1="SELECT voice_staff_disposition,caller_remark,created_at as last_remark_date FROM `caller_history` WHERE staff_id='".$totalData_row['staff_id']."' AND id=(SELECT MAX(id) FROM caller_history WHERE staff_id='".$totalData_row['staff_id']."')";
        ...
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12,$rowCount,$i);
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['project_name']); 
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['company_name']); 
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['country_name']); 
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['region']); 
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['first_name'].' '.$totalData_row['last_name']); 
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['caller_remark']);
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['last_remark_date']);
        $coll12++;
        $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coll12, $rowCount, $totalData_row['username']);
        $coll12++;
            $remark=explode('#',$totalData_row['caller_remark']);
            $data=explode('#',$totalData_row['created_at']);
            $fdata=array();
            foreach($remark as $remark_key =>$remark_val)
            {
                $fdata[$remark_key]['remark']=$remark_val ;
        ...
        $filename = FCPATH . "uploads/call_history_report_".time().".xls";
        ...
        $response['url'] = base_url()."uploads/call_history_report_".time().".xls";
        echo json_encode($response,true);
    }           
    ...
    function excel_download1()
    {
       ...
       $this->load->library('excel');
       $totalData=$this->Projects_model->excel_download1($project_id);  
       ...
       $objPHPExcel->getActiveSheet()->SetCellValue('AE1', 'Assigned By');  
       $objPHPExcel->getActiveSheet()->SetCellValue('AF1', 'Assigned To');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AG1', 'Project Name');   
