...
class Projects extends CI_Controller
{
    ...
    public function update_company_details()
    {
        ...
        $researcher_company_remark=$this->input->post('researcher_company_remark');
        ...
        $company_details=array(
            ...
            'last_name'=>$last_name,
            'updated_job_title'=>$provided_job_title,
                ...
                if($user_list_last_key == $user_list_key){
                    if(!empty($company_name)){
                        foreach ($company_name as $company_name_key => $company_name_row) {
                            ...
                            $company_name_id_info = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('received_company_name' => 
                                    ...
                                    {   
                                        ...
                                        foreach($check_assigned_task as $key => $value)
                                        {
                                            ...
                                            if($this->session->userdata('designation_name') == "Superadmin")
                                            {
                                                ...
                                                $reassignstaff= $this->model->updateData("companywise_allocation",$update_companywise_allocation,array('project_id'=>$value['project_id'],'staff_id'=>$value['staff_id'],'assigned_by => 1 OR assigned_by =>15'));
                                            }
    ...
    function excel_download()
    {
       ...
       $objPHPExcel->getActiveSheet()->SetCellValue('B1', 'Received Company Name');   
       $objPHPExcel->getActiveSheet()->SetCellValue('C1', 'Company Name'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('D1', 'Address');   
       $objPHPExcel->getActiveSheet()->SetCellValue('E1', 'Address2');   
       $objPHPExcel->getActiveSheet()->SetCellValue('F1', 'Address3'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('G1', 'Provided Country');   
       $objPHPExcel->getActiveSheet()->SetCellValue('H1', 'Country');  
       $objPHPExcel->getActiveSheet()->SetCellValue('I1', 'State/County');
       $objPHPExcel->getActiveSheet()->SetCellValue('J1', 'City');   
       $objPHPExcel->getActiveSheet()->SetCellValue('K1', 'Region');   
       $objPHPExcel->getActiveSheet()->SetCellValue('L1', 'Postal Code');   
       $objPHPExcel->getActiveSheet()->SetCellValue('M1','Address Source URL');    
       $objPHPExcel->getActiveSheet()->SetCellValue('N1','Country Code'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('O1', 'Telephone Number');
       $objPHPExcel->getActiveSheet()->SetCellValue('P1', 'Alternate Number');  
       $objPHPExcel->getActiveSheet()->SetCellValue('Q1', 'Website');     
       $objPHPExcel->getActiveSheet()->SetCellValue('R1', 'No. of Employees');
       $objPHPExcel->getActiveSheet()->SetCellValue('S1', 'Industry');   
       $objPHPExcel->getActiveSheet()->SetCellValue('T1', 'Revenue');  
       $objPHPExcel->getActiveSheet()->SetCellValue('U1', 'Co. Disposition');    
       $objPHPExcel->getActiveSheet()->SetCellValue('V1', 'Co. Web Disposition');   
       $objPHPExcel->getActiveSheet()->SetCellValue('W1', 'Co. Voice Disposition');     
       $objPHPExcel->getActiveSheet()->SetCellValue('X1', 'Researcher Co. Remark');   
       $objPHPExcel->getActiveSheet()->SetCellValue('Y1', 'Researcher Co. Note');   
       $objPHPExcel->getActiveSheet()->SetCellValue('Z1', 'Caller Co. Remark'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('AA1', 'Caller Co. Note'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('AB1', 'Salutation');
       $objPHPExcel->getActiveSheet()->SetCellValue('AC1', 'First Name');
       $objPHPExcel->getActiveSheet()->SetCellValue('AD1', 'Last Name');
       $objPHPExcel->getActiveSheet()->SetCellValue('AE1', 'Provided Job Title');
       $objPHPExcel->getActiveSheet()->SetCellValue('AF1', 'Job Title');
       $objPHPExcel->getActiveSheet()->SetCellValue('AG1', 'Job Function');  
       $objPHPExcel->getActiveSheet()->SetCellValue('AH1', 'Provided Email');  
       $objPHPExcel->getActiveSheet()->SetCellValue('AI1', 'Staff Email');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AJ1', 'Staff Department'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('AK1', 'Staff Source Url');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AL1', 'Assumed Email');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AM1', 'Email Harvesting'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('AN1', 'Direct Tel');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AO1', 'Mobile'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('AP1', 'Web Staff Disposition');  
       $objPHPExcel->getActiveSheet()->SetCellValue('AQ1', 'Voice Staff Dispostion');
       $objPHPExcel->getActiveSheet()->SetCellValue('AR1', 'Linkedin Connections Count');     
       $objPHPExcel->getActiveSheet()->SetCellValue('AS1', 'Staff Note');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AT1', 'Research Remark');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AU1', 'Voice Remark');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AV1', 'Created Date');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AW1', 'Updated At');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AX1', 'Updated By');   
       $objPHPExcel->getActiveSheet()->SetCellValue('AY1', 'Assigned To'); 
       $objPHPExcel->getActiveSheet()->SetCellValue('AZ1', 'Staff Id'); 
       $rowCount = 2;
        $i=1;
       foreach($totalData as $totalData_key => $totalData_row)
       {
        $objPHPExcel->getActiveSheet()->SetCellValue('A' . $rowCount, $i);
        $objPHPExcel->getActiveSheet()->SetCellValue('B' . $rowCount, $totalData_row['received_company_name']);
        $objPHPExcel->getActiveSheet()->SetCellValue('C' . $rowCount, $totalData_row['company_name']);
        $objPHPExcel->getActiveSheet()->SetCellValue('D' . $rowCount, $totalData_row['address1']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('E' . $rowCount, $totalData_row['address2']);
        $objPHPExcel->getActiveSheet()->SetCellValue('F' . $rowCount, $totalData_row['address3']);
        $objPHPExcel->getActiveSheet()->SetCellValue('G' . $rowCount, $totalData_row['provided_country']);
        $objPHPExcel->getActiveSheet()->SetCellValue('H' . $rowCount, $totalData_row['updated_country']);
        $objPHPExcel->getActiveSheet()->SetCellValue('I' . $rowCount, $totalData_row['state_county']);
        $objPHPExcel->getActiveSheet()->SetCellValue('J' . $rowCount, $totalData_row['city']);
        $objPHPExcel->getActiveSheet()->SetCellValue('K' . $rowCount, $totalData_row['region']);
        $objPHPExcel->getActiveSheet()->SetCellValue('L' . $rowCount, $totalData_row['postal_code']);
        $objPHPExcel->getActiveSheet()->SetCellValue('M' . $rowCount, $totalData_row['address_souce_url']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('N' . $rowCount, $totalData_row['country_code']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('O' . $rowCount, $totalData_row['tel_number']);
        $objPHPExcel->getActiveSheet()->SetCellValue('P' . $rowCount, $totalData_row['alternate_number']);
        $objPHPExcel->getActiveSheet()->SetCellValue('Q' . $rowCount, $totalData_row['website_url']);  
        $objPHPExcel->getActiveSheet()->SetCellValue('R' . $rowCount, $totalData_row['no_of_emp']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('S' . $rowCount, $totalData_row['industry_type']);    
        $objPHPExcel->getActiveSheet()->SetCellValue('T' . $rowCount, $totalData_row['revenue']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('U' . $rowCount, $totalData_row['company_dispostion']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('V' . $rowCount, $totalData_row['company_web_disposition']);  
        $objPHPExcel->getActiveSheet()->SetCellValue('W' . $rowCount, $totalData_row['company_voice_disposition']);  
        $objPHPExcel->getActiveSheet()->SetCellValue('X' . $rowCount, $totalData_row['researcher_company_remark']);
        $objPHPExcel->getActiveSheet()->SetCellValue('Y' . $rowCount, $totalData_row['researcher_company_note']);
        $objPHPExcel->getActiveSheet()->SetCellValue('Z' . $rowCount, $totalData_row['caller_company_remark']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AA' . $rowCount, $totalData_row['caller_company_note']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('AB' . $rowCount, $totalData_row['prefix']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AC' . $rowCount, $totalData_row['first_name']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AD' . $rowCount, $totalData_row['last_name']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AE' . $rowCount, $totalData_row['provided_job_title']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AF' . $rowCount, $totalData_row['updated_job_title']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AG' . $rowCount, $totalData_row['job_function']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AH' . $rowCount, $totalData_row['provided_staff_email']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AI' . $rowCount, $totalData_row['staff_email']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AJ' . $rowCount, $totalData_row['staff_department']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AK' . $rowCount, $totalData_row['staff_source_url']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AL' . $rowCount, $totalData_row['assumed_email']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AM' . $rowCount, $totalData_row['email_source_url']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AN' . $rowCount, $totalData_row['staff_direct_tel']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('AO' . $rowCount, $totalData_row['staff_mobile']);  
        $objPHPExcel->getActiveSheet()->SetCellValue('AP' . $rowCount, $totalData_row['web_staff_disposition']);  
        $objPHPExcel->getActiveSheet()->SetCellValue('AQ' . $rowCount, $totalData_row['caller_staff_disposition']);    
        $objPHPExcel->getActiveSheet()->SetCellValue('AR' . $rowCount, $totalData_row['staff_linkedin_con']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AS' . $rowCount, $totalData_row['staff_note']); 
        $objPHPExcel->getActiveSheet()->SetCellValue('AT' . $rowCount, $totalData_row['research_remark']);    
        $objPHPExcel->getActiveSheet()->SetCellValue('AU' . $rowCount, $totalData_row['voice_remark']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AV' . $rowCount, $totalData_row['created_date']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AW' . $rowCount, $totalData_row['updated_at']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AX' . $rowCount, $totalData_row['updated_by']);
        $objPHPExcel->getActiveSheet()->SetCellValue('AY' . $rowCount, $totalData_row['reassigned_to']); 
 
            if($totalData_row['has_replaced'] == "")
            { 
                $objPHPExcel->getActiveSheet()->SetCellValue('AZ' . $rowCount, $totalData_row['id']); 
            }else{
                $objPHPExcel->getActiveSheet()->SetCellValue('AZ' . $rowCount, $totalData_row['has_replaced']); 
            }
      
            if($totalData_row['caller_has_replaced'] == "")
            {
                $objPHPExcel->getActiveSheet()->SetCellValue('AZ' . $rowCount, $totalData_row['id']); 
            }else{
                $objPHPExcel->getActiveSheet()->SetCellValue('AZ' . $rowCount, $totalData_row['caller_has_replaced']); 
            }
...
public function insert_noresult_row()
    {
        ...
        if($this->session->userdata('designation_id') == 6)
        {
            ...
            $check_is_added = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('has_replaced' => $staff_id,'activity_type'=>'1'),array('*'),false);
            $has_replaced1 = (!empty($check_is_added)) ? '' : '01' ;
...
public function insert_replacement_row()
    {
        ...
        if($this->session->userdata('designation_id') == 6)
        {
            ...
            $check_is_added = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('has_replaced' => $staff_id,'activity_type'=>3),array('*'),false);
            $has_replaced1 = (!empty($check_is_added)) ? '' : '1' ;
            $co_web_disposition=$get_exisiting_row[0]['web_disposition'];
    ...
    public function insert_staff_row()
    {
        ...
        if($this->session->userdata('designation_id') == 6)
        {
            ...
            $check_is_added = $this->model->selectWhereData('bdcrm_uploaded_feildss',array('has_replaced' => $staff_id,'activity_type'=>2),array('*'),false);
            $has_replaced1 = (!empty($check_is_added)) ? '' : '01' ;
            $co_web_disposition=$get_exisiting_row[0]['web_disposition'];
